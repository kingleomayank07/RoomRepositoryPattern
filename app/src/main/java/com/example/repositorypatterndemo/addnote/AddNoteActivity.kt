package com.example.repositorypatterndemo.addnote
...
class AddNoteActivity : AppCompatActivity() {
    ...
    companion object {
        const val EXTRA_ID = "com.example.repositorypatterndemo.EXTRA_ID"
        const val EXTRA_TITLE = "com.example.repositorypatterndemo.EXTRA_TITLE"
        const val EXTRA_DESCRIPTION = "com.example.repositorypatterndemo.EXTRA_DESCRIPTION"
        const val EXTRA_PRIORITY = "com.example.repositorypatterndemo.EXTRA_PRIORITY"
    }
